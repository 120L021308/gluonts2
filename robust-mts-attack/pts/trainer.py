        ...
        for epoch_no in range(self.epochs):
            ...
            with tqdm(train_iter, total=total) as it:
                for batch_no, data_entry in enumerate(it, start=1):
                    ...
                    cumm_epoch_loss = cumm_epoch_loss+loss.item()
            ...
            if validation_iter is not None:
                ...
                with tqdm(validation_iter, total=total, colour="green") as it:
                    for batch_no, data_entry in enumerate(it, start=1):
                        ...
                        cumm_epoch_loss_val =cumm_epoch_loss_val+ loss.item()
        ...
        for epoch_no in range(self.epochs):
            ...
            with tqdm(train_iter, total=total) as it:
                for batch_no, data_entry in enumerate(it, start=1):
                    ...
                    inputs["past_target_cdf"] = inputs["past_target_cdf"] + delta
                    output = net(**inputs)
                    ...
                    perturbed_inputs["past_target_cdf"] =perturbed_inputs["past_target_cdf"]+ delta
